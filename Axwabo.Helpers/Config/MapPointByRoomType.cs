...
namespace Axwabo.Helpers.Config {
    ...
    [Serializable]
    public readonly struct MapPointByRoomType {
        ...
        public MapPointByRoomType(RoomType type) : this(type, Vector3.zero, Quaternion.identity) {
        }
        ...
        public MapPointByRoomType(RoomType type, Vector3 positionOffset) : this(type, positionOffset, Quaternion.identity) {
        }
        ...
        public MapPointByRoomType(RoomType type, float x = 0, float y = 0, float z = 0) : this(type, new Vector3(x, y, z), Quaternion.identity) {
        }
        ...
        public MapPointByRoomType(RoomType type, Vector3 positionOffset, Quaternion rotationOffset) {
            Type = type;
