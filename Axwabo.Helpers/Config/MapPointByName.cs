...
namespace Axwabo.Helpers.Config {
    ...
    [Serializable]
    public readonly struct MapPointByName {
        ...
        public MapPointByName(string name) : this(name, Vector3.zero, Quaternion.identity) {
        }
        ...
        public MapPointByName(string name, Vector3 positionOffset) : this(name, positionOffset, Quaternion.identity) {
        }
        ...
        public MapPointByName(string name, float x, float y, float z) : this(name, new Vector3(x, y, z), Quaternion.identity) {
        }
        ...
        public MapPointByName(string name, Vector3 positionOffset, Quaternion rotationOffset) {
            RoomName = name;
