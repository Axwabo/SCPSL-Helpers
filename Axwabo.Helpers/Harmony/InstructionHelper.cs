...
namespace Axwabo.Helpers.Harmony {
    ...
    public static class InstructionHelper {
        ...
        public static CodeInstruction Check => new(OpCodes.Ceq);
        ...
        public static CodeInstruction Call(Type type, string methodName, Type[] parameters = null, Type[] generics = null) {
            return Call(AccessTools.Method(type, methodName, parameters, generics) ?? throw new ArgumentException($"No method found for type={type}, name={methodName}, parameters={parameters.Description()}, generics={generics.Description()}"));
        }
        ...
        public static CodeInstruction New(Type type, Type[] parameters = null) {
            return New(AccessTools.Constructor(type, parameters) ?? throw new ArgumentException($"No constructor found for type={type}, parameters={parameters.Description()}"));
        }
        ...
        public static CodeInstruction Ldfld(Type type, string fieldName) {
            return Ldfld(AccessTools.Field(type, fieldName) ?? throw new ArgumentException($"No field found for type={type}, name={fieldName}"));
        }
        ...
        public static CodeInstruction Stfld(Type type, string fieldName) {
            return Stfld(AccessTools.Field(type, fieldName) ?? throw new ArgumentException($"No field found for type={type}, name={fieldName}"));
        }
        ...
        public static CodeInstruction Ldflda(Type type, string fieldName) {
            return Ldflda(AccessTools.Field(type, fieldName) ?? throw new ArgumentException($"No field found for type={type}, name={fieldName}"));
        }
        ...
        public static int FindCall(this List<CodeInstruction> list, Type type, string methodName, Type[] parameters = null, Type[] generics = null, int start = 0) {
            return FindCall(list, AccessTools.Method(type, methodName, parameters, generics) ?? throw new ArgumentException($"No method found for type={type}, name={methodName}, parameters={parameters.Description()}, generics={generics.Description()}"), start);
        }
        ...
        public static int FindField(this List<CodeInstruction> list, Type type, string fieldName, int start = 0) {
            return FindField(list, AccessTools.Field(type, fieldName) ?? throw new ArgumentException($"No field found for type={type}, name={fieldName}"), start);
        }
